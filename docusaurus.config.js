  ...
  plugins: [
    [
      "docusaurus-plugin-remote-content",
      {
        ...
        documents: [
          "/conductor-python/main/README.md",
          ...
          "conductor-clojure/main/README.md",
    ...
    [
      "docusaurus-plugin-remote-content",
      {
        ...
        name: "content", // used by CLI, must be path safe
        sourceBaseUrl:
          "https://raw.githubusercontent.com/Netflix/conductor/main/", // the base url for the markdown (gets prepended to all of the documents when fetching)
        outDir: "docs/how-tos/sdks", // the base directory to output to.
        documents: [
    ...
    [
      "docusaurus-plugin-remote-content",
      {
        ...
        name: "content", // used by CLI, must be path safe
        sourceBaseUrl:
          "https://raw.githubusercontent.com/orkes-io/orkes-conductor-community/main/", // the base url for the markdown (gets prepended to all of the documents when fetching)
    ...
    [
      "docusaurus-plugin-remote-content",
      {
        ...
        name: "content", // used by CLI, must be path safe
        sourceBaseUrl:
          "https://raw.githubusercontent.com/conductor-sdk/conductor-examples/main/", // the base url for the markdown (gets prepended to all of the documents when fetching)
