...
The output shows the generated workflow (execution) ID of the started workflow.
...
To find the newly started workflow execution, go to **Executions** > **Workflow** and search for the workflow containing the Start Workflow task. Select the workflow to view the execution and select the Start Workflow task. The **Summary** tab contains the workflow execution link to the started workflow.
