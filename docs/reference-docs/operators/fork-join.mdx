...
description: "Learn how the Fork/Join task runs parallel task branches in Orkes Conductor and merges results using a Join task, with configuration examples."
---
