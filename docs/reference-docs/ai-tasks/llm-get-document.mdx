...
description: "Learn how the LLM Get Document task retrieves stored documents for further AI processing or analysis."
---
...
The LLM Get Document task will return the following parameters.
...
Here are some examples for using the LLM Get Document task.

<details>
<summary>Using an LLM Get Document task in a workflow</summary>

See an example of [building a document classification workflow using the LLM Get Document task](https://orkes.io/content/templates/document-classifier).
