...
:::info Prerequisites
If the location is not publicly available, you must create an appropriate integration with the required access keys or tokens. Integrate the following with Orkes Conductor, depending on your source:
- [Git Repository]
- [Cloud Providers]
:::
...
```json
{
  ...
  "description": "The task to list files.",
  "version": 1,
  "tasks": [
    {
      "name": "list_files",
