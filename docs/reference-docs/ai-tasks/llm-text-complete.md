...
| inputParameters.**promptName** | The AI prompt created in Orkes Conductor. You can only use the prompts for which you have access.<br/><br/>**Note**: If you haven’t created an AI prompt for your language model, refer to the documentation on [creating AI Prompts in Orkes Conductor](https://orkes.io/content/developer-guides/creating-and-managing-gen-ai-prompt-templates). | Required. |
...
This is the JSON schema for an LLM Text Complete task definition.
