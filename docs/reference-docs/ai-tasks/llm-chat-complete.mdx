...
| inputParameters. **messages.message** | The corresponding input message to be provided. It can also be [passed as a dynamic input](https://orkes.io/content/developer-guides/passing-inputs-to-task-in-conductor). | Optional. |
