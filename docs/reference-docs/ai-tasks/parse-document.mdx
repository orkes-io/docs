...
description: "Learn how the Parse Document task extracts, converts, and structures documents into Markdown for AI processing and semantic workflows."
---
