...
| --------- | --------------------------------------------------- | ------ | ------------------ |
| humantaskId    | The task (execution) ID for the Human task execution. | string | Required.          |
...
```shell
curl -X 'GET' \
  'https://<YOUR-CLUSTER>/api/human/template/b5070997-d326-11ef-a7d0-3e3f9199f5b3' \
