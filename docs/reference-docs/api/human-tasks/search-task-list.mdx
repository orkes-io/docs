...
| taskInputQuery          | The query expression for the input data to the Human task, in the format `FIELD = VALUE` or `FIELD IN (value1, value2)`. Only AND and OR operations are supported. <br/><br/> Wildcard (*) can be used for partial values e.g. FIELD = s*me.                                                                                                                                                                                                                                                     | string           | Optional.                           |
