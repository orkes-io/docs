...
description: "Learn how to create multiple human task user forms in bulk."
---
...
| templateUI | The UI configuration that defines how the form should be rendered. [Supported form layout and components](/content/developer-guides/orchestrating-human-tasks). | object | Required. | 
