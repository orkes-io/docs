...
```shell
curl -X 'POST' \
  'https://<YOUR-SERVER-URL>/api/workflow/someWorkflow/correlated?includeClosed=false&includeTasks=false' \
  -H 'accept: */*' \
...
<details>
<summary>Get all workflows based on correlation IDs</summary>

**Request**

```shell
curl -X 'POST' \
  'https://<YOUR-SERVER-URL>/api/workflow/someWorkflow/correlated?includeClosed=true&includeTasks=false' \
  -H 'accept: */*' \
  -H 'X-Authorization: <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '[
    ...
    },
    {
      ...
      "output": {
        "output": {
          "response": {
            "headers": {
              "Date": ["Fri, 17 Jan 2025 05:27:43 GMT"],
  ...
  "2": [
    {
      ...
      "output": {
        "output": {
          "response": {
            "headers": {
              "Date": ["Fri, 17 Jan 2025 05:28:11 GMT"],
              "Content-Type": ["application/json"],
              "Content-Length": ["182"],
              "Connection": ["keep-alive"],
              "Strict-Transport-Security": [
