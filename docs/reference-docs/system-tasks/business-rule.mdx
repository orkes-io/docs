...
| inputParamemeter.**inputColumns**      | The inputs to the rule file, which can be fixed or [passed as a dynamic input](https://orkes.io/content/developer-guides/passing-inputs-to-task-in-conductor). Supports string, number, boolean, null, and object/array.                                                                                                                                                                                                                       | Required.          |
