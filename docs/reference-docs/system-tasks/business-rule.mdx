...
- **List Operators**: **inList** and **!=inList**  
  For example, `productName inList ["phone", "laptop"]` will match if _productName_ is phone or laptop.
- **createList**  
