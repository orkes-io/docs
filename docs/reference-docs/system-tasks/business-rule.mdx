...
| inputParamemeter.**inputColumns**      | The inputs to the rule file, which can be fixed or [passed as a dynamic input](/developer-guides/passing-inputs-to-task-in-conductor). Supports string, number, boolean, null, and object/array.                                                                                                                                                                                                                       | Required.          |
