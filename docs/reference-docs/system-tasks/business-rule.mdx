...
description: "Learn how the Business Rule task evaluates business rules defined in spreadsheet-based decision tables."
---
...
| inputParameter.**inputColumns**      | The inputs to the rule file, which can be fixed or [passed as a dynamic variable](/developer-guides/passing-inputs-to-task-in-conductor). Supports string, number, boolean, null, and object/array.                                                                                                                                                                                                                       | Required.          |
| inputParameter.**outputColumns**     | List of columns that will be present in the task output, which can be fixed or [passed as a dynamic variable](/developer-guides/passing-inputs-to-task-in-conductor).                                                                                                                                                                                                                                                                                                                                                                                 | Required.          |
