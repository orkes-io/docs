...
description: "Learn how the JDBC task executes SQL queries and manages data in relational databases."
---
...
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | 
| inputParameters. **integrationName**     | The relational database integration to use with the JDBC task.<br/><br/>If your database isn't configured on your Conductor cluster, go to the **Integrations** tab and configure it under **[RDBMS > Relational Database](/integrations/rdbms/relational-database)**. | Required.                                                    |
