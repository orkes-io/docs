...
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | 
| inputParameters. **integrationName**     | The relational database integration to use with the JDBC task. If your database isn't configured on your Conductor cluster, go to the Integrations tab and configure it under **[RDBMS > Relational Database](https://orkes.io/content/integrations/rdbms/relational-database)**. | Required.                                                    |
