...
See an example of [using SendGrid Event Webhooks in Orkes Conductor](/content/tutorials/using-sendgrid-webhooks).
...
See an example of [building a GitHub pull request reviewer assignment workflow using Orkes Conductor](/content/tutorials/github-webhook).
...
See an example of [building a Stripe payment confirmation workflow in Orkes Conductor](/content/tutorials/stripe-webhook).
...
See an example of [building a Microsoft Teams webhook processing workflow in Orkes Conductor](/content/tutorials/microsoft-teams-webhook).
