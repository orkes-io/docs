...
See an example of [creating a standup bot using Slack Webhook.](https://orkes.io/content/templates/daily-scrum-automation-using-standup-bot).
...
<details>
<summary>Using variable idempotency keys in webhook-trigerred workflows</summary>
<p>

See an example of [using variable idempotency keys in webhook-trigerred workflows.](/content/tutorials/using-idempotency-keys-in-webhook-triggered-workflows).
