...
<details>
<summary>Using variable idempotency keys in webhook-triggered workflows</summary>
<p>

See an example of [using variable idempotency keys in webhook-triggered workflows.](/content/tutorials/using-idempotency-keys-in-webhook-triggered-workflows).
