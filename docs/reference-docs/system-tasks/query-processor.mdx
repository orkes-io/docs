...
- **Conductor Metrics (Prometheus)**—This query type retrieves [workflow and task performance metrics](/content/developer-guides/metrics-and-observability) as well as system statistics through Prometheus.
...
| Parameter                         | Description                                                                                                                                                                                                                    | Required/ Optional |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------ |
| inputParameters. **metricsQuery** | The Prometheus query to execute. Refer to [the list of metrics published to the Conductor server](/content/developer-guides/metrics-and-observability) to formulate your query.                              | Required.          |
