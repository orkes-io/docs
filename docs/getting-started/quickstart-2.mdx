...
1. Log in to your Orkes cluster or the [Orkes Developer Edition](https://developer.orkescloud.com/?utm_campaign=quickstarts&utm_source=orkes-doc&utm_medium=web).
...
:::note
If you are using [Orkes Developer Edition](https://developer.orkescloud.com/?utm_campaign=quickstarts&utm_source=orkes-doc&utm_medium=web), you can only create one application. Use the same application as the worker project for this step.
:::
