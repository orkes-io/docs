...
5. Set the credentials in the workflow client file for your language:
...
6. (Skip this step if you are using [Developer Edition](https://developer.orkescloud.com/)) Grant the application permission to the `helloWorld` workflow definition:
