...
5. Set the `base_url`, Key ID, and Key Secret in `workflow_as_code.py`, located at `conductor-apps/python/quickstarts/create-your-first-workflow/workflow_as_code.py`.
