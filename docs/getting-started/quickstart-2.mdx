...
5. Set the credentials in the workflow client file for your language:
    * **Python** — Update the credentials in`conductor-apps/python/quickstarts/create-your-first-workflow/workflow_as_code.py`. Note that `base_url` should not include `/api`.
    * **Java** — Update the credentials in `conductor-apps/java/quickstarts/create-your-first-workflow/src/main/java/io/orkes/conductor/examples/WorkflowAsCode.java`. Note that `basePath` should include `/api`.
    * **JavaScript** — Set as environment variables before running:
      ...
      ```
    * **C#** — Update the credentials in `conductor-apps/csharp/quickstarts/create-your-first-workflow/workflow_as_code.cs`. Note that `BasePath` should include `/api`.
    * **Go** — Update the credentials in `conductor-apps/go/quickstarts/create-your-first-workflow/workflow_as_code.go`. Note that `SERVER_URL` should include `/api`.
6. Grant the application permission to the `helloWorld` workflow definition:
...
```shell
cd conductor-apps/python/quickstarts/create-your-first-workflow
...
```shell
cd conductor-apps/java/quickstarts/create-your-first-workflow
...
```shell
cd conductor-apps/javascript/quickstarts/create-your-first-workflow
npm install
...
```shell
cd conductor-apps/csharp/quickstarts/create-your-first-workflow
dotnet run
```
</TabItem>
<TabItem value="go" label="Go">
...
**Go**
```shell
cd conductor-apps/go/quickstarts/create-your-first-workflow
