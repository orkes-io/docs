...
Update the following in `conductor-apps/python/developer-guides/using-workers/main.py`. Note that `base_url` should not include `/api`.
...
Update the following in `conductor-apps/java/developer-guides/using-workers/src/main/java/io/orkes/conductor/examples/Main.java`. Note that `basePath` should include `/api`.
...
Update the following in `conductor-apps/csharp/developer-guides/using-workers/Worker.cs`. Note that `BasePath` should include `/api`.
...
Update the following in `conductor-apps/go/developer-guides/using-workers/worker.go`. Note that `API_URL` should include `/api`.
