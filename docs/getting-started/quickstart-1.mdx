...
1. Log in to your Orkes cluster or [Orkes Developer Playground](https://developer.orkescloud.com/?utm_campaign=quickstarts&utm_source=orkes-doc&utm_medium=web).
...
:::note
If you are using [Orkes Developer Playground](https://developer.orkescloud.com/?utm_campaign=quickstarts&utm_source=orkes-doc&utm_medium=web), you can only create one application with the Admin role enabled.
:::
...
5. Set the Key ID and Key Secret in your project.
    ...
    **Example** (Python)
    ...
    ```
6. (Skip this step if you are using [Orkes Developer Playground](https://developer.orkescloud.com/?utm_campaign=quickstarts&utm_source=orkes-doc&utm_medium=web)) Grant Execute permission to the application.
