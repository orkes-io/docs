...
* [Python](https://github.com/conductor-oss/awesome-conductor-apps/blob/main/python/developer-guides/using-workers)
...
5. (Skip this step if you are using [Developer Edition](https://developer.orkescloud.com/?utm_campaign=quickstarts&utm_source=orkes-doc&utm_medium=web)) Grant Execute permission to the application:
