...
A workflow can still successfully run to completion even with incorrect logic. To verify that data has been correctly passed between tasks, select a task and inspect its **Input** or **Output** tab.
