...
description: "Get started with Orkes Conductor. Learn core concepts, install the platform, and build your first workflow to orchestrate distributed systems."
---
...
- **Orkes Conductor** is the enterprise-ready version of Conductor OSS, available fully managed or self-hosted. It adds hosted operations, visual debugging, role based access control, secrets, schedules, webhooks, observability, integrations, and support.
...
- **Agent runtime**: Conductor includes a built-in runtime for durable AI agents. It is separate from Conductor Skills, which help coding agents author and operate Conductor workflows.
