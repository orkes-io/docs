...
3. Rename the workflow and task names. For example, rename the workflow as _"document_classifier_your_name"_.
4. Select **Save**.
...
3. In **AI/LLM** section, choose your preferred LLM provider and select **+ Add**.
   ...
   <p align="center">
     <img
       src="/content/img/document-classifier-switch-task.png"
       alt="Document Classifier Workflow with Switch Task explanation"
       width="70%"
       height="auto"
     ></img>
   </p>
...
- In **LLM provider**, replace _dl-test-3_ with your integrated LLM provider.
- In **Model**, replace _gpt-3.5-turbo_ with your integrated model.
- In **Prompt template**, replace _doc_classifier_prompt_ with your prompt.
