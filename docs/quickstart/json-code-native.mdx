---
slug: "/quickstarts/json-code-native"
description: "Conductor stores workflow definitions as JSON, the canonical runtime format — create dynamic workflows, version them, and expose as APIs or MCP tools."
---
