---
slug: "/quickstarts/tasks"
description: "Learn about tasks in Conductor — the reusable building blocks of workflows, including system tasks, worker tasks, operators, and LLM tasks with 14+ AI providers."
---
...
| Category | Tasks |
|---|---|
| **Core** | HTTP, Inline (script), Event, Wait, Human, JSON JQ Transform |
| **Flow Control** | Fork/Join, Dynamic Fork, Join, Switch, Do While, Sub Workflow, Start Workflow, Set Variable, Terminate, Dynamic |
| **AI / LLM** | Chat Completion, Text Completion, Embeddings, Vector Search, Content Generation |
