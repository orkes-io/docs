...
description: "Core concepts of Orkes Conductor — a durable workflow orchestration engine for distributed workflows, microservice orchestration, and AI agents."
---
...
- **Run Your Tasks Externally** — Implement tasks using external workers in microservices, serverless functions, or applications. [Learn more](/content/quickstarts/workers)
