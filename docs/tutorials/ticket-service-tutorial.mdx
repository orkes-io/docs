...
Authentication settings define how MCP clients are authorized to access the tool. In this example, the service uses public authentication.
...
## Step 8: Verify using MCP Inspector
...
Use this as the MCP server endpoint when you configure your AI tool. Let’s verify this using MCP Inspector before plugging into an AI agent.
...
3. Open the UI at http://localhost:6274.
4. In **Transport Type**, select **Streamable HTTP**.
5. In **URL**, enter the **MCP Tool Remote Endpoint** copied from Conductor.
6. Select **Connect**.
7. Once the connection is successful, select **List tools** to view the routes.

<p align="center"><img src="/content/img/mcp-inspector-configuration.png" alt="MCP Inspector configuration" width="100%" height="auto"></img></p>

8. Select the **POST_create** tool, and enter the parameters.
9. Select **Run Tool**.

<p align="center"><img src="/content/img/testing-using-mcp-inspector.gif" alt="Testing from MCP Inspector" width="100%" height="auto"></img></p>
