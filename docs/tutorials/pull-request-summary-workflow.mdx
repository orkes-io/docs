...
- The AI prompt instructs the language model to focus on what changed and why the change matters, while avoiding code-level or implementation-specific details.
