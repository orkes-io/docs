...
<ol>
<li>Log in to the <a href="https://id.atlassian.com/">Atlassian account</a>.</li>
<li>Go to <strong>Security</strong> &gt; <strong><a href="https://id.atlassian.com/manage-profile/security/api-tokens">API tokens</a></strong>.</li>
...
<ol start="4">
<li>Enter a name for the token and set an expiration.</li>
...
<li>Run the following command, replacing the placeholders with your credentials:</li>
</ol>
...
<ol start="3">
<li>Copy the output, which is your Base64-encoded authentication string.</li>
</ol>
...
<ol>
<li>Go to <a href="https://developer.orkescloud.com/secrets"><strong>Definitions</strong> &gt; <strong>Secret</strong></a> from the left navigation menu on your Conductor cluster.</li>
<li>Select <strong>+ Add secret</strong>.</li>
<li>Set the <strong>Secret name</strong> as <em>atlassian-token</em>.</li>
<li>Paste the Base64 encoded string as the <strong>Secret value</strong>.</li>
</ol>
...
<ol start="5">
<li>Select <strong>Add</strong> to save the secret.</li>
</ol>
...
<ol>
<li>Go to <a href="https://developer.orkescloud.com/workflowDef"><strong>Definitions</strong> &gt; <strong>Workflows</strong></a> and select <strong>+ Define workflow.</strong></li>
...
<ol>
<li>Go to <a href="https://developer.orkescloud.com/configure-webhooks"><strong>Definitions</strong> &gt; <strong>Webhook</strong></a> from the left navigation menu on your Conductor cluster.</li>
...
<ul>
<li>In <strong>Webhook name</strong>, enter a webhook name such as <em>CreateJiraTickets</em>.</li>
<li>Select <strong>Source platform</strong> as <strong>Custom</strong>.</li>
<li>Set a request <strong>Header</strong> for the webhook.</li>
<li>Enable <strong>Start workflow when webhook event comes</strong>.</li>
<li>In the <strong>Workflow name</strong>, select <em>ticket-automation-workflow</em>.</li>
<li>In the <strong>Idempotency key</strong>, enter <code>${workflow.input.bug_id}</code>.</li>
<li>Set the <strong>Idempotency strategy</strong> as <strong>Return Existing</strong>.</li>
</ul>
...
<ol>
<li>Re-run the same cURL request using the same <em>bug_id</em> value as before.</li>
</ol>
...
<ol start="2">
<li>Check the webhook activity in Conductor. A new event is received, but no new workflow is triggered. You can verify this by comparing timestamps.</li>
</ol>
