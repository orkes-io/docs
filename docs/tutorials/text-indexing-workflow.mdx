...
description: "Learn how to build workflows that index text into a vector database and search it to generate answers from indexed content."
---
...
<li>After saving, update the <strong>LLM Index Text</strong> task with your actual values:</li>
</ol>

<p align="center"><img src="/content/img/modifying-kb-index-test-workflow.png" alt="Modifying workflow" width="80%" height="auto" /></p>

<ul>
<li>In <strong>Vector database</strong>, replace <code>&lt;YOUR-VECTOR-DB-INTEGRATION&gt;</code> with your integration name created in <a href="/content/tutorials/text-indexing-search-workflow#step-2-integrate-pinecone-as-the-vector-database">Step 2</a>.</li>
<li>In <strong>Index</strong>, replace <code>&lt;YOUR-INDEX&gt;</code> with your index name created in <a href="/content/tutorials/text-indexing-search-workflow#step-2-integrate-pinecone-as-the-vector-database">Step 2</a>.</li>
<li>In <strong>Embedding model provider</strong>, replace <code>&lt;YOUR-LLM-PROVIDER&gt;</code> with your OpenAI integration name created in <a href="/content/tutorials/text-indexing-search-workflow#step-1-integrate-an-ai-model-provider">Step 1</a>.</li>
