...
This initiates the workflow and takes you to the workflow execution page. Since the loan amount is less than $10,000, it is automatically approved, and the user receives an email via SendGrid.
