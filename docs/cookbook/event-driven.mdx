---
slug: "/eventing"
description: "Event-driven workflow recipes for Orkes Conductor — publishing to message brokers, triggering workflows from events, and completing tasks from external events."
---
