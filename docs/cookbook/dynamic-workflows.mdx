---
description: "Workflow as code — build code-first workflows dynamically in Python using the Conductor SDK, with conditional branching, loops, and parallel execution."
---
