...
[To recap](/content/core-concepts), workflows are composed of tasks in a defined order. They can be triggered by code, an API call, a cron schedule, webhooks, or external eventing systems (AWS SQS, Kafka, and so on). 
...
Integrations with tools like Prometheus, Grafana, and Datadog allow you to easily collect and monitor system performance data.
