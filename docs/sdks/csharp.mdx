---
slug: "/sdks/csharp"
description: "Learn how to use the Conductor C# SDK to build and run orchestrated applications."
---
...
See [Security via Applications](/content/access-control-and-security/applications#configuring-applications) for details on how to get an access key and secret.
