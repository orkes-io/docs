---
slug: "/ai-orchestration/ai-llm-recipes"
description: "LLM orchestration cookbook - AI agent orchestration recipes for chat completion, RAG pipelines, web search, and code execution."
---
...
:::tip Prerequisites
Requires a vector database (Pinecone, Weaviate, pgvector, or MongoDB Atlas) and an LLM provider configured as integrations on your Orkes Conductor cluster. See [Vector database integrations](/category/integrations/vector-databases) and [AI/LLM integrations](/category/integrations/ai-llm).
:::
...
- [AI/LLM integrations](/category/integrations/ai-llm) - Anthropic, OpenAI, Azure OpenAI, Google Gemini, AWS Bedrock, Mistral, Cohere, HuggingFace, Ollama, and more.
- [Vector database integrations](/category/integrations/vector-databases) - Pinecone, Weaviate, pgvector, and MongoDB Atlas.
