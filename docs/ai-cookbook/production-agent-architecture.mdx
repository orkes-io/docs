---
slug: "/ai-orchestration/production-agent-architecture"
...
- **[Failure Semantics for AI Agents](/ai-orchestration/failure-semantics)** - The exact failure contract: what happens under crashes, retries, duplicates, and long waits.
- **[Why Conductor for Agents](/why-conductor)** - What Conductor gives you out of the box for agentic workflows.
- **[Build Your First AI Agent](/ai-orchestration/first-ai-agent)** - Start simple and build up to this architecture in 5 minutes.
- **[Token Efficiency](/ai-orchestration/token-efficiency)** - How durable execution saves tokens and reduces LLM costs.
