...
The region where your Google Cloud project or storage bucket is hosted (for example, us-central1, asia-south1, or eu). 
...
| Location | The region where your GCP project is hosted. For example, us-central1. | 
