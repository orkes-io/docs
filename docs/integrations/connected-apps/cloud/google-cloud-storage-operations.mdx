---
slug: "/integrations/google-cloud-storage-operations"
...
| Storage Class | The storage class for the bucket. Supported values: `STANDARD`, `NEARLINE`, `COLDLINE`, `ARCHIVE`. | string | Optional. |
...
| Storage Class | The new storage class for the bucket. Supported values: `STANDARD`, `NEARLINE`, `COLDLINE`, `ARCHIVE`. | string | Optional. |
