---
slug: "/integrations/google-cloud-functions-operations"
...
| --------- | ----------- | ---- | ----------------- |
| Project ID | The Google Cloud project ID. If not provided, defaults to the [project ID configured in the integration]. | string | Optional. |
| Location | The region where the functions are deployed. For example: `us-central1`.  If not provided, defaults to the location configured in the integration. | string | Optional. |
