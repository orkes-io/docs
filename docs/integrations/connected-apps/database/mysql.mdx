...
<li>In the <strong>Database</strong> section, choose <strong>MySQL</strong>.</li>
...
<li>In <strong>Add Task</strong> panel on the right, search for <strong>MySQL</strong>, and select the integration created in <a href="/content/integrations/mysql#step-2-add-an-integration-for-mysql">Step 2</a>.</li>
</ol>
