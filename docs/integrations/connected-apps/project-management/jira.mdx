...
<li>In the <strong>Project Management</strong> section, choose <strong>Jira</strong>.</li>
...
<li>In <strong>Add Task</strong> panel on the right, search for <strong>Jira</strong>, and select the integration created in <a href="/content/integrations/jira#step-2-add-an-integration-for-jira">Step 2</a>.</li>
</ol>
