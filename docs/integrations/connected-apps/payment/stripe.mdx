...
<li>In the <strong>Payment</strong> section, choose <strong>Stripe</strong>.</li>
...
<li>In <strong>Add Task</strong> panel on the right, search for <strong>Stripe</strong>, and select the integration created in <a href="/content/integrations/stripe#step-2-add-an-integration-for-stripe">Step 2</a>.</li>
</ol>
