...
<li>In the <strong>Productivity</strong> section, choose <strong>Google Slides</strong>.</li>
...
<li>In <strong>Add Task</strong> panel on the right, search for <strong>Google Slides</strong>, and select the integration created in <a href="/content/integrations/google-calendar#step-2-add-an-integration-for-google-calendar">Step 2</a>.</li>
</ol>
