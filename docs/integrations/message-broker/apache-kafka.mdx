...
4. Choose either **Global access** or **Granular access**.
5. Copy and store the **Key** and **Secret**.
...
<li>In the <strong>Message Broker</strong> section, choose <strong>Apache Kafka</strong>.</li>
