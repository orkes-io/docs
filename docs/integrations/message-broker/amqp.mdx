...
To integrate AMQP with Orkes Conductor, set up [AMQP](https://www.amqp.org/) according to your requirements and retrieve the following credentials from your AMQP console:
