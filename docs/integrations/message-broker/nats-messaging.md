...
| Select security protocol | Choose the security protocol for authenticating the connection. It can take values: <ul><li>**_NONE_**</li><li>**_JWT_** - If JWT is opted, upload the JWT credentials file. </li><li>**_TOKEN_BASED_AUTHENTICATION_**</ul>| 
