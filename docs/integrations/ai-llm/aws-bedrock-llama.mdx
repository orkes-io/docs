...
2. Select **+ New model**.
3. Enter the **Model name**. The name must exactly match the AWS Bedrock Llama3 model name. For a complete list, see the [AWS Bedrock Llama3 documentation](https://docs.aws.amazon.com/bedrock/latest/userguide/titan-models.html).
