...
:::note
Once the integration is ready, [start creating workflows](https://orkes.io/content/getting-started/first-workflow-application) with [LLM tasks](https://orkes.io/content/category/reference-docs/ai-tasks).
:::