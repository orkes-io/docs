...
description: "Learn how to integrate AWS Bedrock Llama 2 with your Orkes Conductor cluster."
---

# Integrating with AWS Bedrock Llama 2 in Orkes Conductor
...
AWS Bedrock Llama 2 offers a range of models that can be incorporated into the Orkes Conductor cluster. The choice of model depends on your unique use case, the functionalities you require, and the specific natural language processing tasks you intend to tackle. 
...
You have now integrated your Orkes Conductor cluster with the AWS Bedrock Llama 2 provider. The next step is to integrate with the specific models. 
