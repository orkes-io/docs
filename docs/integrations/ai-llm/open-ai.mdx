...
<ol>
<li>Sign in to the <a href="https://platform.openai.com/">OpenAI platform</a>.</li>
<li>Go to <strong>Dashboard</strong> &gt; <strong><a href="https://platform.openai.com/api-keys">API keys</a></strong> from the left menu and select <strong>+ Create new secret key</strong>.</li>
<li>In <strong>Owned by</strong>, select <strong>You</strong>.</li>
...
<ol start="5">
<li>Select <strong>Create secret key</strong>.</li>
<li>Copy and store the generated key securely, as it is shown only once.</li>
</ol>
...
<li>Sign in to the <a href="https://platform.openai.com/">OpenAI platform</a>.</li>
<li>Go to <strong>Dashboard</strong> &gt; <strong><a href="https://platform.openai.com/api-keys">API keys</a></strong> from the left menu and select <strong>+ Create new secret key</strong>.</li>
<li>In <strong>Owned by</strong>, select <strong>Service account</strong>.</li>
<li>Configure the following parameters:</li>
</ol>
...
<li>In the <strong>AI/LLM</strong> section, choose <strong>OpenAI</strong>.</li>
