...
| Auth Header Name<br/><br/> <TableNote title="Available since">v5.2.6 and later</TableNote> | The name of the authentication header to include in requests. | Optional. | 
...
2. Select **+ New model**.
3. Enter the **Model name** and a **Description**. Add the model that you have set up on your local device.
