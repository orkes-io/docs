...
- [Conductor is running locally](/content/get-orkes-conductor#local-setup-with-docker), and Ollama is running locally.
...
<ol>
<li>Download and install the <a href="https://ollama.com/download">Ollama app</a>.</li>
<li>Open the app on your device.</li>
<li>Choose the model you want to run from the list of <a href="https://ollama.com/library">supported Ollama models</a>. You should have at least 8 GB of RAM available to run the 7B models, 16 GB to run the 13B models, and 32 GB to run the 33B models.</li>
<li>Pull the model locally with the following command.</li>
</ol>
...
<ol start="5">
<li>Once downloaded, run the model using the command:</li>
</ol>
...
<ol start="6">
<li>Enter prompts in the terminal to verify that the model runs locally.</li>
</ol>
...
<li>In the <strong>AI/LLM</strong> section, choose <strong>Ollama</strong>.</li>
...
Once the integration is configured, set access controls to manage which [applications](/content/access-control-and-security/applications) or [groups](/content/access-control-and-security/users-and-groups#groups) can use the models.
...
With the integration in place, you can now create workflows using [AI/LLM tasks](/content/category/reference-docs/ai-tasks).
