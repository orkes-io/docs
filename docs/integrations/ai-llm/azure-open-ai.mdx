...
:::info Prerequisites
To use Azure OpenAI models with Orkes Conductor, you must first deploy the [desired models in your Azure portal](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/create-resource?pivots=web-portal#deploy-a-model). Once deployment is complete, proceed with adding the model to your Orkes Conductor cluster.
:::
