...
export const projectFaqs = [
  {
    question: 'Is Conductor still maintained?',
    answer:
  ...
  {
    question: 'Is this the same project that started at Netflix?',
    answer:
  ...
  {
    question: 'What is the difference between Conductor OSS and Orkes Conductor?',
    answer:
  ...
  {
    question: 'Is Conductor an AI framework?',
    answer:
...
[
  ...
  },
  {
    ...
    {
    question: 'Can I execute a workflow only up to a particular task for testing?',
    answer:
...
<FAQStructuredData faqs={projectFaqs} />
