...
| actions. complete_task. **workflowId** | The execution ID of the workflow that contains the task to be marked as failed. | Required if using `workflowId` and `taskRefName`method. |
