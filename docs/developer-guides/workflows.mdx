...
3. **[Visual workflow builder](/content/developer-guides/build-workflows-using-ui)**—Using Conductor UI, define your workflow visually, which is formatted as JSON under the hood.
