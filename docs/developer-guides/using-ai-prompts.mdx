...
<details>
<summary>Agentic interview app</summary>

Check out the tutorial on how to build an [agentic coding interview application](/content/tutorials/agentic-interview-app).

</details>
<details>
<summary>Document classifier</summary>

Check out the tutorial on how to build a [document classification system](/content/templates/document-classifier).
