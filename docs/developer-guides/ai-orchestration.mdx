...
- **[Build Your First AI Agent](/content/ai-agents/first-ai-agent)** &mdash; Step-by-step: discover MCP tools, call an LLM, execute, add human approval, make it autonomous. 5 minutes.
