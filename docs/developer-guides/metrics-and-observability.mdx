...
- For on-premise deployments, you must set up your own monitoring tools.
:::
...
The Conductor server collects the following metrics via Prometheus, which can be visualized in Grafana/Datadog for monitoring and alerting.
