...
1. Configure an application account.
    ...
    2. Create a new application or select an application to which you will be adding your worker. <br/> Ensure that the application role has **Worker** enabled.
...
3. In the visual workflow editor, select the **(+)** icon to add a new task. There are two ways to add a worker task:
...
* [Monitoring task queues](https://orkes.io/content/developer-guides/monitoring-task-queues)
