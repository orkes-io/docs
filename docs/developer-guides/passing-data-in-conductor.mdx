...
<Tabs>
<TabItem value="From Workflow Inputs" label="From Workflow Inputs" className={"paddedContent"}>
...
<TabItem value="From Task Outputs" label="From Task Outputs"  className={"paddedContent"}>
...
<TabItem value="From Secrets" label="From Secrets"  className={"paddedContent"}>
...
<TabItem value="From Workflow Variables" label="From Workflow Variables"  className={"paddedContent"}>
