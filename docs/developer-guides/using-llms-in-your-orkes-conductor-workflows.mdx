...
5. Set access limits to the AI model, prompt, or vector database to govern which applications or groups can use them.
...
* [AWS Bedrock Llama2](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html)
...
**To integrate an LLM:**
1. Go to **Integrations** from the left menu on your Orkes Conductor cluster.
2. Select **+ New integration** from the top-right of your window.
3. In the **AI** or **AI/LLM** section, select **+ Add** to integrate your preferred model provider.
...
4. Enter the required parameters for the chosen provider.
    ...
    :::note
    The integration configuration differs with each model provider. For detailed steps on integrating with each provider, refer to [AI/LLM Integrations](/category/integrations).
    :::
...
* [AWS Bedrock Llama 2 models](https://docs.aws.amazon.com/bedrock/latest/userguide/models-supported.html)
