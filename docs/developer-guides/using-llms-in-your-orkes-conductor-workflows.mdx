...
4. Enter the required parameters for the chosen provider.
    ...
    :::note
    The integration configuration differs with each model provider. For detailed steps on integrating with each provider, refer to [AI/LLM Integrations](/category/integrations/ai-llm).
    :::
