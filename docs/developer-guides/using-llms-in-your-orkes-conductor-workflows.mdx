...
5. Set access limits to the AI model and prompt to govern which applications or groups can use them.
...
6. Repeat Steps 3-5 for the AI prompt as well. In the **Prompt** tab, select the required prompt and toggle the necessary permissions.
