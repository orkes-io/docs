...
- **Last Poll Time** : The time (in milliseconds) the task was last polled.

Use the filter options to narrow down task queues based on queue size, worker count, and last poll time.

<p align="center"><img src="/content/img/filtering-task-queues.png" alt="Filtering Task Queues" width="100%" height="auto"></img></p>
