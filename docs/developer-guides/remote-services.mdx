...
3. In **Service registry name**, enter a unique name for the service. This name cannot be changed after the service is created.
...
To clone an existing service definition, select the clone icon next to the service in the Remote Services list, or select **Clone** on the service's detail page. Enter a new name for the cloned service and select **Clone**. The new service is created with all the configuration and methods copied from the original.
...
| Method Type | The method type for the service. This field is required. Supported values:<ul><li>GET</li><li>POST</li><li>PUT</li><li>DELETE</li><li>PATCH</li></ul>
...
| Method Type | The method type for the service. This field is required. Supported values:<ul><li>UNARY</li><li>SERVER_STREAMING</li><li>CLIENT_STREAMING</li><li>BIDIRECTIONAL_STREAMING</li></ul>
