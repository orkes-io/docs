...
When [running a workflow from the Conductor UI](/content/developer-guides/running-workflows-in-ui#run-workflow), enter the mapping in the **Tasks to domain mapping** field on the **Run Workflow** panel:
