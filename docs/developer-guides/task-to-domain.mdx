...
When [running a workflow from the Conductor UI](/content/how-to-videos/run-workflow#run-workflow), enter the mapping in the **Tasks to domain mapping** field on the **Run Workflow** panel:
