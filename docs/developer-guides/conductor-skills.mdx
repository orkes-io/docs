---
slug: /conductor-skills
description: "Conductor Skills — teach your AI coding agent to create, run, and manage Conductor workflows. Works with Claude Code, Cursor, Copilot, and more."
---
