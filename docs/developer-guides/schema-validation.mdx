---
sidebar_label: Input/Output Schema Validation
...
<Tabs>
<TabItem value="taskdef" label="Task definition">
...
<TabItem value="taskconfig" label="Task configuration">
...
<TabItem value="workflowdef" label="Workflow definition">
