...
* **Human Task Manager**: Can create, view, update, and delete all Human Task templates (user forms) in the cluster.
* **Event Handler Manager**: Can create, view, update, and delete all event handlers in the cluster.
* **Schedule Manager**: Can create, view, update, and delete all workflow schedules in the cluster.
...
Configure the application’s roles and permissions to control what your application can do and what resources it can access, including workflows, tasks, agents, secrets, environment variables, tags, domains, integrations, and prompts.
...
4. Add permissions to grant application-level access to resources, including workflows, tasks, agents, secrets, environment variables, tags, domains, integrations, and prompts.
...
Manage applications programmatically with the [Applications API](/reference-docs/api/applications), including creating applications, generating access keys, and managing application roles and permissions.
