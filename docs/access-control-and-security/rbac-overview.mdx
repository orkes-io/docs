...
| Human Task Manager <TableNote title="Available since"><ul><li>v5.5.2 and later</li></ul></TableNote> | Can create, view, update, and delete all Human Task templates (user forms) in the cluster.                                                                                                            |
| Event Handler Manager <TableNote title="Available since"><ul><li>v5.5.2 and later</li></ul></TableNote> | Can create, view, update, and delete all event handlers in the cluster.                                                                                                            |
| Schedule Manager <TableNote title="Available since"><ul><li>v5.5.2 and later</li></ul></TableNote> | Can create, view, update, and delete all workflow schedules in the cluster.                                                                                                            |
...
| Human Task Manager <TableNote title="Available since"><ul><li>v5.5.2 and later</li></ul></TableNote> | Can create, view, update, and delete all Human Task templates (user forms) in the cluster. <br/> <br/> This role can only be granted by an Admin.                                                                                           |
| Event Handler Manager <TableNote title="Available since"><ul><li>v5.5.2 and later</li></ul></TableNote> | Can create, view, update, and delete all event handlers in the cluster. <br/> <br/> This role can only be granted by an Admin.                                                                                           |
| Schedule Manager <TableNote title="Available since"><ul><li>v5.5.2 and later</li></ul></TableNote> | Can create, view, update, and delete all workflow schedules in the cluster. <br/> <br/> This role can only be granted by an Admin.                                                                                           |
