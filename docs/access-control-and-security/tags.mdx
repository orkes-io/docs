...
1. In the left navigation menu, go to **Definitions** and select **Workflow** / **Task** / **User Forms** / **Event Handler** / **Scheduler** / **Secrets** / **Webhook** / **AI Prompts**  /  **Environment Variables**.
