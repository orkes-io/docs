...
_Workflow orchestration_ describes an approach in which a single, centralized service—commonly known as the “orchestrator”—is responsible for invoking other services and handling and combining their responses to execute a composite business workflow.
...
On the other hand, _workflow choreography_ is a decentralized approach in which each service is responsible for invoking and responding to adjacent services.
