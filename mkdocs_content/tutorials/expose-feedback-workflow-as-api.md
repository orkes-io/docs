...
updated: "2026-05-14"
keywords: "Orkes Conductor, workflow orchestration, Build a Feedback API Using Orkes Conductor API Gateway, Build a Feedback API Using Orkes Conductor API Gateway tutorial, API orchestration, API gateway"
---
...
The workflow accepts a rating and comment as input, processes the values using a simple Inline task, and returns a formatted confirmation message.
