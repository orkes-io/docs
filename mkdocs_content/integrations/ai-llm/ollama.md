...
updated: "2026-05-14"
keywords: "Orkes Conductor, workflow orchestration, Ollama Integration with Orkes Conductor, Ollama Integration with Orkes Conductor integration, Ollama Integration with Orkes Conductor workflow automation, AI orchestration, LLM orchestration, agent workflows"
---
...
| Auth Header Name<br/><br/> <span class="table-note"><strong>Available since:</strong> v5.2.6 and later</span> | The name of the authentication header to include in requests. The name of the authentication header to include in requests. Required only when Ollama is exposed behind a secured endpoint or proxy. | Optional. | 
| Auth Header <br/><br/> <span class="table-note"><strong>Available since:</strong> v5.2.6 and later</span> | The authentication value associated with the header. | Optional. |
