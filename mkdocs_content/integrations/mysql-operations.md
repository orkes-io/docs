---
title: "MySQL Operations Reference"
...
=== "Input Parameters"
    ...
    | Column Definitions | The column definitions for the table. Supported formats:<ul><li>JSON array (e.g., `[{"name":"id","type":"INT PRIMARY KEY AUTO_INCREMENT"}]`)</li><li>comma-separated string (e.g., `id:INT PRIMARY KEY AUTO_INCREMENT`)</li></ul> | string | Required. |
...
- [MySQL Integration with Orkes Conductor](/content/integrations/mysql)
