...
<div class="wcc-widget" role="tablist">
  <div class="wcc-left">
    <div class="wcc-item wcc-active" data-wcc="0" role="tab" aria-selected="true" tabindex="0">
      ...
      <div class="wcc-body">Define workflows consisting of multiple tasks that are executed in a specific order. <a href="/content/reference-docs/workflow-definition">Learn more</a></div>
    </div>
    <div class="wcc-item" data-wcc="1" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Use switch-case operators to make branching decisions. <a href="/content/reference-docs/operators/switch">Learn more</a></div>
    </div>
    <div class="wcc-item" data-wcc="2" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Use the Do-While loop operator to iterate through a set of tasks. <a href="/content/reference-docs/operators/do-while">Learn more</a></div>
    </div>
    <div class="wcc-item" data-wcc="3" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Execute tasks in parallel using either static or dynamic forks. <a href="/content/reference-docs/operators/fork-join">Learn more</a></div>
    </div>
    <div class="wcc-item" data-wcc="4" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Implement tasks using external workers in microservices, serverless functions, or applications. <a href="/content/quickstarts/workers">Workers</a> · <a href="/content/category/sdks">SDKs</a></div>
    </div>
    <div class="wcc-item" data-wcc="5" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Use built-in tasks for common actions such as calling HTTP endpoints, writing to event queues, and executing inline code. <a href="/content/category/reference-docs/system-tasks">Learn more</a></div>
    </div>
    <div class="wcc-item" data-wcc="6" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Use LLM tasks to build AI-powered workflows, including agentic workflows. <a href="/content/ai-orchestration">Learn more</a></div>
    </div>
    <div class="wcc-item" data-wcc="7" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Plug in manual steps in your workflows using Human tasks. <a href="/content/reference-docs/operators/human">Human tasks</a> · <a href="/content/reference-docs/operators/wait">Wait tasks</a></div>
    </div>
    <div class="wcc-item" data-wcc="8" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Set timeouts and rate limits to manage failures for tasks and workflows. <a href="/content/error-handling">Learn more</a></div>
    </div>
    <div class="wcc-item" data-wcc="9" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Replay completed or failed workflows from the beginning, from any task, or retry just the failed step — even months later. Full execution history is always preserved. <a href="/content/developer-guides/debugging-workflows">Learn more</a></div>
    </div>
    <div class="wcc-item" data-wcc="10" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Connect Conductor to your ecosystem with event-driven triggers using Kafka, NATS, SQS, AMQP, and webhooks. <a href="/content/eventing">Learn more</a></div>
    </div>
    <div class="wcc-item" data-wcc="11" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Track and debug workflows from Conductor UI. View inputs, pull logs, and restart from any point. <a href="/content/quickstarts">Get started</a></div>
    </div>
    <div class="wcc-item" data-wcc="12" role="tab" aria-selected="false" tabindex="0">
      ...
      <div class="wcc-body">Run multiple server instances behind a load balancer with shared backends for high availability. <a href="/content/get-orkes-conductor">Deployment guide</a></div>
    </div>
  </div>
