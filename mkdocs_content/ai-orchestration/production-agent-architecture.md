...
canonical_route: "ai-orchestration/production-agent-architecture"
updated: "2026-05-14"
...
Every tool call (`CALL_MCP_TOOL`, `HTTP`, `SIMPLE`) inherits retry behavior from its [task definition](/content/reference-docs/task-definition):
