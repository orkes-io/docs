...
description: "Human-in-the-loop patterns for AI agents — pre-execution approval, conditional post-execution review, LLM-as-judge automated review, and durable human."
canonical_route: "ai-orchestration/human-in-the-loop"
updated: "2026-05-14"
...
- **[Durable Agents](/content/ai-orchestration/durable-agents)** &mdash; What persists, what gets retried, error handling, and multi-agent composition.
...
- **[HUMAN task reference](/content/reference-docs/operators/human)** &mdash; Full configuration options for the HUMAN system task.
