...
canonical_route: "ai-orchestration/failure-semantics"
updated: "2026-05-14"
...
**If you want to apply the new definition:** Use [restart with latest definitions](/content/quickstarts/durable-execution#replay-and-recovery). This re-executes the workflow from the beginning using the updated definition.
...
- **[Production Agent Architecture](/content/ai-orchestration/production-agent-architecture)** — The canonical end-to-end agent pattern.
- **[Durable Execution Semantics](/content/quickstarts/durable-execution)** — The full persistence model, task state machine, and retry configuration.
...
- **[Token Efficiency](/content/ai-orchestration/token-efficiency)** — How durable execution saves tokens across all these failure scenarios.
