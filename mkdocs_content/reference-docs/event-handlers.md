...
See [Event Task](/content/reference-docs/system-tasks/event) for documentation.
...
Input for starting a workflow and output when completing / failing task follows the same [expressions](/content/reference-docs/workflow-definition#using-expressions) used for wiring task inputs.
