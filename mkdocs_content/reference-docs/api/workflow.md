...
For starting workflows, see [Start Workflow API](/content/reference-docs/api/workflow/start-workflow-execution).
...
Get the URI for external payload storage. See [External Payload Storage](https://docs.conductor-oss.org/documentation/advanced/externalpayloadstorage).
