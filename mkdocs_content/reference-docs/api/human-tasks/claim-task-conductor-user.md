---
title: "Claim Task (Conductor User)"
description: "Use the Orkes Conductor human tasks API to claim Task (Conductor User). Includes endpoint details, authentication, parameters, request bodies."
