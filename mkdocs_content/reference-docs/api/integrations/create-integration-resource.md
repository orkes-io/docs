...
canonical_route: "reference-docs/api/integrations/create-integration-resource"
updated: "2026-05-14"
keywords: "Orkes Conductor, workflow orchestration, Create or Update Integration Resource, Create or Update Integration Resource API, API orchestration, API gateway"
---
