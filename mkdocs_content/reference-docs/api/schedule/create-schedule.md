...
description: "Use the Orkes Conductor schedules API to create Schedule. Includes endpoint details, authentication, parameters, request bodies, response behavior."
canonical_route: "reference-docs/api/schedule/create-schedule"
updated: "2026-05-14"
keywords: "Orkes Conductor, workflow orchestration, Create Schedule, Create Schedule API, API orchestration, API gateway"
---
...
Use this schedules endpoint to create Schedule. It is intended for automation scripts, CI/CD jobs, backend services, and internal tools that need to manage Orkes Conductor programmatically.

- **Method and path**: `POST` `/api/scheduler/schedules`
