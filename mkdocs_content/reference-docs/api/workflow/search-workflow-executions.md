...
updated: "2026-05-14"
keywords: "Orkes Conductor, workflow orchestration, Search Workflow Executions, Search Workflow Executions API, API orchestration, API gateway"
---
...
Returns the total number of results in _totalHits_ and a list of workflow executions in a _results_ array.

## Examples

<details>
<summary>Search based on workflow name</summary>

**Request**

```shell
curl -X 'GET' \
  'https://<YOUR-SERVER-URL>/api/workflow/search?start=0&size=100&freeText=%2A&query=workflowType%3DsomeWorkflow' \
  -H 'accept: */*' \
...
<details>
<summary>Search for workflows based on workflow name and status</summary>

**Request**

```shell
curl -X 'GET' \
  'https://<YOUR-SERVER-URL>/api/workflow/search?start=0&size=100&freeText=%2A&query=status%20IN%20%28RUNNING%29%20AND%20workflowType%3DcompensationWorkflow' \
  -H 'accept: */*' \
  -H 'X-Authorization: <TOKEN>'
```
...
<details>
<summary>Search for workflows based on freeText</summary>

**Request**

```shell
curl -X 'GET' \
  'https://<YOUR-SERVER-URL>/api/workflow/search?start=0&size=15&freeText=dubai' \
  -H 'accept: */*' \
  -H 'X-Authorization: <TOKEN>'
```
...
```json
{
  ...
  "results": [
    {
      "workflowType": "GetWeatherDubai",
      "version": 2,
      "workflowId": "fd7scb6d1b03-71db-11f0-af9d-8e9bff353733",
      "startTime": "2025-08-05T09:08:47.318Z",
      "updateTime": "2025-08-05T09:08:47.934Z",
      "endTime": "2025-08-05T09:08:47.930Z",
      "status": "COMPLETED",
      "input": "{subWorkflowDefinition=null, workflowInput={}, subWorkflowTaskToDomain=null, subWorkflowName=GetWeatherDubai, subWorkflowPriority=null, _createdBy=john.doe@acme.com, subWorkflowVersion=2}",
      "output": "{result={unit=Celsius, temperature=36.5, windspeed=8.6, location=Dubai, UAE, time=2025-08-05T09:00}}",
      "executionTime": 612,
      "failedReferenceTaskNames": "",
      "priority": 0,
      "failedTaskNames": [],
    ...
    {
      "workflowType": "SequentialHTTPWorkflow",
      "version": 1,
      "workflowId": "fd7s98125d99-6ed5-11f0-a7fc-a652d19b1278",
      "startTime": "2025-08-01T12:46:50.691Z",
      "updateTime": "2025-08-01T12:46:51.554Z",
      "endTime": "2025-08-01T12:46:51.552Z",
      "status": "COMPLETED",
      "input": "{ipaddress=86.99.24.5}",
      "output": "{zipcode=, weather=Overcast, temperature_C=23}",
      "executionTime": 861,
      "failedReferenceTaskNames": "",
      "priority": 0,
      "failedTaskNames": [],
