...
description: "Use the Orkes Conductor users API to get User Permission over Resources. Includes endpoint details, authentication, parameters, request bodies."
