...
canonical_route: "reference-docs/api/task/task-queue/get-task-queue-size-for-individual-tasks"
updated: "2026-05-14"
keywords: "Orkes Conductor, workflow orchestration, Get Task Queue Size for a Task Type, Get Task Queue Size for a Task Type API, API orchestration, API gateway, workflow tasks, task queues"
---
