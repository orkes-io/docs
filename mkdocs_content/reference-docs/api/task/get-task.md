...
canonical_route: "reference-docs/api/task/get-task"
updated: "2026-05-14"
keywords: "Orkes Conductor, workflow orchestration, Get Task by ID, Get Task by ID API, API orchestration, API gateway, workflow tasks, task queues"
---
