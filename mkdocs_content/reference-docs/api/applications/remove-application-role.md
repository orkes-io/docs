...
description: "Use the Orkes Conductor applications API to remove Role from Application. Includes endpoint details, authentication, parameters, request bodies."
