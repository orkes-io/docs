---
title: "Metadata API"
description: "Use the Orkes Conductor metadata API to metadata API. Includes endpoint details, authentication, parameters, request bodies, response behavior, and examples."
canonical_route: "reference-docs/api/metadata"
updated: "2026-05-14"
...
Registers a new workflow definition. Request body is a [Workflow Definition](/content/reference-docs/workflow-definition).
...
Creates or updates workflow definitions in bulk. Request body is a list of [Workflow Definitions](/content/reference-docs/workflow-definition). Returns a `BulkResponse` indicating success and failure for each definition.
...
Registers new task definitions. Request body is a list of [Task Definitions](/content/reference-docs/task-definition).
...
Updates an existing task definition. Request body is a single [Task Definition](/content/reference-docs/task-definition).
