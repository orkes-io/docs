...
description: "Use the Orkes Conductor Conductor API to event Handlers API. Includes endpoint details, authentication, parameters, request bodies, response behavior, and."
canonical_route: "reference-docs/api/event-handlers"
updated: "2026-05-14"
...
For details on configuring event handlers, see [Event Handler Configuration](/content/reference-docs/event-handlers). For configuring message broker connections, see the [Event Bus Orchestration](/content/eventing) guide.
