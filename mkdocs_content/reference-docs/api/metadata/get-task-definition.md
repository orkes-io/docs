...
description: "Use the Orkes Conductor metadata API to get Task Definition. Includes endpoint details, authentication, parameters, request bodies, response behavior, and."
