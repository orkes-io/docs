...
updated: "2026-05-14"
keywords: "Orkes Conductor, workflow orchestration, API Gateway: Expose Workflows as APIs, API orchestration, API gateway"
---
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>MCP Enabled</td>
      <td>
        Determines whether the MCP is active for this service. Enabled by default. Since this service is configured as an API gateway, this can be disabled.      
      </td>
      <td>Required.</td>
    </tr>
  </tbody>
