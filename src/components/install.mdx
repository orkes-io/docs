<details>
<summary>Use Conductor Playground</summary>
<p>
...
3. Click **Create Application** button to create a new application, give it a name
4. Open the newly created application
5. Click **Create Access Key** to create the KEY and SECRET. A dialog box opens with newly generated Key and Secret.
6. **Important**: Copy and store the Key and Secret in a safe location. The secret is NEVER displayed again.
...
<details>
<summary>Install and Run Locally</summary>
<p>
