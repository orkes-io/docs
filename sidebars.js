...
const sidebars = {
    docs: [
        ...
        },
        {
            ...
            link: {
                type: 'generated-index',
                title: 'Task Reference Docs',
                description: 'Reference documentation for Orkes Conductor - Tasks',
        ...
        },
        {
            ...
            link: {
                ...
                description: 'Reference documentation for Orkes Conductor - API',
                slug: '/category/reference-docs/api',
                keywords: ['reference', 'apis', 'operators', 'api', 'tasks', 'system', 'system-tasks']
            },
            items: [
                {
