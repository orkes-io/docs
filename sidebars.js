    ...
    referenceSidebar: [
        {
            ...
            items: [
                'reference-docs/worker-task',
                {
                    type: 'category',
                    label: 'Operators',
                    link: { type: 'doc', id: 'reference-docs/operators' },
                    items: [
                        { type: 'doc', id: 'reference-docs/operators/switch', label: 'Switch' },
                        { type: 'doc', id: 'reference-docs/operators/do-while', label: 'Do While' },
                        { type: 'doc', id: 'reference-docs/operators/fork-join', label: 'Fork/Join' },
                        { type: 'doc', id: 'reference-docs/operators/dynamic-fork', label: 'Dynamic Fork' },
                        { type: 'doc', id: 'reference-docs/operators/join', label: 'Join' },
                        { type: 'doc', id: 'reference-docs/operators/dynamic', label: 'Dynamic' },
                        { type: 'doc', id: 'reference-docs/operators/sub-workflow', label: 'Sub Workflow' },
                        { type: 'doc', id: 'reference-docs/operators/start-workflow', label: 'Start Workflow' },
                        { type: 'doc', id: 'reference-docs/operators/terminate-workflow', label: 'Terminate Workflow' },
                        { type: 'doc', id: 'reference-docs/operators/terminate', label: 'Terminate' },
                        { type: 'doc', id: 'reference-docs/operators/wait', label: 'Wait' },
                        { type: 'doc', id: 'reference-docs/operators/human', label: 'Human' },
                ...
                },
                {
                    type: 'category',
                    label: 'System Tasks',
                    link: { type: 'doc', id: 'reference-docs/system-tasks' },
                    items: [
                        ...
                        { type: 'doc', id: 'documentation/configuration/workflowdef/systemtasks/pull-workflow-messages-task', label: 'Pull Workflow Messages' },
                        {
                            ...
                            link: { type: 'doc', id: 'reference-docs/alerting-tasks' },
                            items: [
            ...
            items: [
                ...
                },
                {
                    ...
                    link: {
                        type: 'generated-index',
                        title: 'Gateway',
                        slug: '/reference-docs/api/gateway',
                        description: 'Learn how to create and manage gateway services and their authentication configurations using the Gateway APIs.',
                    },
                    items: [{ type: 'autogenerated', dirName: 'reference-docs/api/gateway' }],
                },
            ],
        },
        {
